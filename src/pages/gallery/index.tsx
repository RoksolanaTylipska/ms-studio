...
function Gallery() {
  return (
    <>
      <Head>
        <title>MS Laser | Cтудія лазерної епіляції, електроепіляції, шугарингу та воскової депіляції у Львові
        </title>
        ...
        <meta property="og:title" content="Студія лазерної епіляції, електроепіляції, шугарингу та воскової депіляції у Львові | MS Laser" />
